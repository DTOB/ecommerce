...
class ProvincesControllerTest < ActionController::TestCase
  ...
  test "should create province" do
    assert_difference('Province.count') do
      post :create, province: { created_at: @province.created_at, gst: @province.gst, hst: @province.hst, name: @province.name, pst: @province.pst, updated_at: @province.updated_at }
    end
  ...
  test "should update province" do
    patch :update, id: @province, province: { created_at: @province.created_at, gst: @province.gst, hst: @province.hst, name: @province.name, pst: @province.pst, updated_at: @province.updated_at }
    assert_redirected_to province_path(assigns(:province))
  end
